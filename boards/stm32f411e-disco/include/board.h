...
#define GPIO_TIM3_CH1OUT  (GPIO_TIM3_CH1OUT_1|GPIO_SPEED_50MHz)  /* PA6 - Motor1 pulse */
...
#define GPIO_TIM1_CH2IN   GPIO_TIM1_CH2IN_1   /* PA9 */
#define GPIO_TIM1_CH3IN   GPIO_TIM1_CH3IN_1   /* PA10 */

/* Sensor EXTI inputs */

#define GPIO_MOTOR1_LIMIT_UP    (GPIO_INPUT|GPIO_PULLUP|GPIO_EXTI|GPIO_PORTC|GPIO_PIN6)   /* PC6  */
...
#define GPIO_BTN_STARTSTOP  (GPIO_INPUT|GPIO_PULLUP|GPIO_EXTI|GPIO_PORTD|GPIO_PIN12)  /* PD12 */
#define GPIO_BTN_EMERGENCY  (GPIO_INPUT|GPIO_PULLUP|GPIO_EXTI|GPIO_PORTD|GPIO_PIN13)  /* PD13 */
#define GPIO_BTN_RESTART    (GPIO_INPUT|GPIO_PULLUP|GPIO_EXTI|GPIO_PORTD|GPIO_PIN14)  /* PD14 */
